 ...
 * @author helge
 */
public class OGoNotesInsert extends OGoDocumentObjectInsert {
  // TBD: deprecated? is there anything special with notes?
  
  public OGoNotesInsert(final OGoObjectContext _oc) {
    super(_oc, "Notes");
  }
